...
****** Merge all datasets *****************************************************
  ...
  * Relabel variables to make them informative
   label var w1_h "W: Housing and other durables"
   label var w2_l "W: Land"
   label var w3_e "W: Agricultural equipment and structure capital"
   label var w4_1_c "W: Livestock - Cattle and packed animals"
   label var w4_2_s "W: Livestock - Small animals"
   label var w4_3_p "W: Livestock - Poultry"
   label var W "WEALTH"
